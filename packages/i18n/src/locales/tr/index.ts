...
export const tr = {
  ...
  nav: {
    ...
    switchToWorkLayout: "Çalışma alanını ortaya taşı",
    switchToChatLayout: "Sohbeti ortaya taşı",
    collapseWorkArea: "Çalışma alanını daralt",
    expandWorkArea: "Çalışma alanını genişlet",
    collapseChatPane: "Sohbeti daralt",
    expandChatPane: "Sohbeti genişlet",
    sessions: "Oturumlar",
    ...
    copySessionReference: "Oturum başvurusunu kopyala",
  ...
  chat: {
    ...
    sessionReferenceRemoved: "{{name}} oturum başvurusu kaldırıldı",
    removeSessionReference: "{{name}} oturum başvurusunu kaldır",
    sessionReferenceDuplicate: "{{count}} yinelenen oturum başvurusu atlandı",
    sessionReferenceNotReferenced: "Bu oturum bu iletide başvurulmadı",
    sessionReferenceReadFailed: "Başvurulan oturum okunamadı",
