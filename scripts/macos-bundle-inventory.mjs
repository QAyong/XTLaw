...
//
// Why this exists: osx-sign walks the whole `XTLaw.app` and runs one
...
// signed XTLaw.app produced 91 invocations distributed over extensions
...
//   example `release/mac-arm64/XTLaw.app`). `--json` appends one
 ...
 * level down (`release/mac-arm64/XTLaw.app`); a build directory may hold it
