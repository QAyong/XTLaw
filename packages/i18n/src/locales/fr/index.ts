...
export const fr = {
  ...
  "tray": {
    ...
    "open": "Ouvrir XTLaw",
    "quit": "Quitter XTLaw",
    "askTitle": "Garder XTLaw en arrière-plan ?",
    "askBody": "Lorsque vous fermez la fenêtre, XTLaw peut continuer à s'exécuter dans la barre d'état système afin que rien ne soit perdu. Vous pouvez modifier cela à tout moment dans les paramètres.",
    "closeToTray": "Près du bac",
    "confirmQuitTitle": "Quitter XTLaw ?",
  ...
  "nav": {
    ...
    "switchToWorkLayout": "Déplacer l’espace de travail au centre",
    "switchToChatLayout": "Déplacer la conversation au centre",
    "collapseWorkArea": "Réduire l’espace de travail",
    "expandWorkArea": "Développer l’espace de travail",
    "collapseChatPane": "Réduire la conversation",
    "expandChatPane": "Développer la conversation",
    "sessions": "Sessions",
    ...
    "copySessionReference": "Copier la référence de session",
  ...
  "chat": {
    ...
    "placeholder": "Demandez à XTLaw de vous aider pour tout",
    ...
    "sessionReferenceRemoved": "Référence de session {{name}} supprimée",
    "removeSessionReference": "Supprimer la référence de session {{name}}",
    "sessionReferenceDuplicate": "{{count}} référence(s) de session en double ignorée(s)",
    "sessionReferenceNotReferenced": "Cette session n'est pas référencée dans ce message",
    "sessionReferenceReadFailed": "Impossible de lire la session référencée",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Stockée dans XTLaw et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
  ...
  "scheduled": {
    "description": "Exécutez des tâches récurrentes tant que XTLaw est ouvert.",
    ...
    "localTimeHint": "Utilise le fuseau horaire local. Gardez XTLaw ouvert ; les exécutions manquées sont ignorées. Les actions restreintes nécessitent une autorisation.",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Ajoute les fournisseurs définis par ce plugin à la liste des fournisseurs des Paramètres. Le plugin fournit le point de terminaison et les modèles ; votre clé API reste dans XTLaw.",
      "desktop.control": "Permet d'appeler le catalogue XTLaw contrôlé ; les opérations destructrices exigent toujours confirm=true et le bearer token MCP n'est pas exposé.",
      ...
      "keyboard.globalShortcut": "Enregistre des raccourcis clavier système qui déclenchent les commandes propres à ce plugin lorsque XTLaw n'est pas au premier plan.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Cette version de XTLaw est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de XTLaw qui a ouvert ces données en dernier, ou une version ultérieure.",
    "archMismatch":
