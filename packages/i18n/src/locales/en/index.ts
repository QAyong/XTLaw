export const en = {
  ...
  nav: {
    ...
    switchToWorkLayout: "Move work area to center",
    switchToChatLayout: "Move chat to center",
    collapseWorkArea: "Collapse work area",
    expandWorkArea: "Expand work area",
    collapseChatPane: "Collapse chat",
    expandChatPane: "Expand chat",
    sessions: "Sessions",
    ...
    copySessionReference: "Copy session reference",
  ...
  chat: {
    ...
    sessionReferenceRemoved: "Removed session reference {{name}}",
    removeSessionReference: "Remove session reference {{name}}",
    sessionReferenceDuplicate: "Skipped {{count}} duplicate session reference(s)",
    sessionReferenceNotReferenced: "That session was not referenced in this message",
    sessionReferenceReadFailed: "Couldn't read the referenced session",
