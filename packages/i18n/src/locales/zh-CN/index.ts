...
export const zhCN = {
  ...
  nav: {
    ...
    switchToWorkLayout: "将工作区移到中间",
    switchToChatLayout: "将聊天区移到中间",
    collapseWorkArea: "收起工作区",
    expandWorkArea: "展开工作区",
    collapseChatPane: "收起聊天区",
    expandChatPane: "展开聊天区",
    sessions: "会话",
  ...
  chat: {
    ...
    sessionReferenceRemoved: "已移除会话引用 {{name}}",
    removeSessionReference: "移除会话引用 {{name}}",
    sessionReferenceDuplicate: "已跳过 {{count}} 个重复会话引用",
    sessionReferenceNotReferenced: "此会话未在本条消息中被引用",
    sessionReferenceReadFailed: "无法读取被引用的会话",
