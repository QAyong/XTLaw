...
function applyPreferredWidth(surface: HTMLElement | null, width: number) {
  ...
  // Per-message prose must track the band when the user widens it beyond the
  // default pane cap.
...
/**
 * Dual edge handles for the centered conversation band. Both sides change
 * one preferred max-width; the live band is `min(100%, preferred)`.
 */
