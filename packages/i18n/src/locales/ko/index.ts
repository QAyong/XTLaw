...
export const ko = {
  ...
  nav: {
    ...
    switchToWorkLayout: "작업 영역을 가운데로 이동",
    switchToChatLayout: "채팅을 가운데로 이동",
    collapseWorkArea: "작업 영역 접기",
    expandWorkArea: "작업 영역 펼치기",
    collapseChatPane: "채팅 접기",
    expandChatPane: "채팅 펼치기",
    sessions: "세션",
  ...
  chat: {
    ...
    sessionReferenceRemoved: "세션 참조 {{name}} 제거됨",
    removeSessionReference: "세션 참조 {{name}} 제거",
    sessionReferenceDuplicate: "중복된 세션 참조 {{count}}개를 건너뜀",
    sessionReferenceNotReferenced: "이 메시지에는 해당 세션 참조가 없습니다",
    sessionReferenceReadFailed: "참조한 세션을 읽을 수 없음",
